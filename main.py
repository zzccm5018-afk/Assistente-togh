...
Variáveis de ambiente (.env / Railway -> Variables):
  ...
  Opcionais (têm padrão)
    GEMINI_CHAT_MODEL          padrão "gemini-2.5-flash-lite" (modelo ativo, pode ser
                                trocado em tempo real pela tabela model_config)
    GEMINI_FALLBACK_MODELS     padrão "gemini-2.5-flash-lite,gemini-2.0-flash"
                                ...
                                repetidos ou iguais ao ativo são ignorados.)
...
_DEFAULT_FALLBACK_MODELS = "gemini-2.5-flash-lite,gemini-2.0-flash"
